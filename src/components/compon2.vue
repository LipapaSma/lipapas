      ...
      skills: [
        {
          ...
          child: [
            ...
            {name: 'Bootstrap', background: 'rgba(29, 218, 61, 0.2)'},
            {name: 'MUI', background: 'rgba(29, 218, 61, 0.2)'}
          ]
        },
        {
          name: '技能',
          ...
          child: [
            {name: 'JavaScript', background: 'rgba(211, 184, 30, 0.2)'},
            {name: 'Jquery', background: 'rgba(211, 184, 30, 0.2)'},
            {name: 'Less Sass', background: 'rgba(211, 184, 30, 0.2)'},
            {name: 'H5C3', background: 'rgba(211, 184, 30, 0.2)'}
          ]
        },
        {
          name: '工具',
          ...
          child: [
            ...
            {name: 'Gulp', background: 'rgba(232, 13, 24, 0.2)'},
