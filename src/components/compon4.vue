  ...
  <div class="info">
    ...
    <transition
      ...
      <div class="cont"  v-if="show">
        ...
        <div class="contact">
          <h2>联系我</h2>
          <p><i class="iconfont icon-shouji"></i>  19952410170</p>
          <p><i class="iconfont icon-youxiang"></i>  13655164281@163.com</p>
        </div>
        <div class="acount">
          <el-row>
...
export default {
  data () {
    return {
      show: false,
      accounts: [
        {class: 'icon-GitHub', link: 'https://github.com/LipapaSma'},
        {class: 'icon-sf', link: 'https://segmentfault.com/u/lipapasma'},
        {class: 'icon-zhihu', link: 'https://www.zhihu.com'},
        {class: 'icon-xinlang', link: 'https://weibo.com'}
      ]
    }
  },
  methods: {
